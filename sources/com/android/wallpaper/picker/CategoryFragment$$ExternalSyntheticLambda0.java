...
public final /* synthetic */ class CategoryFragment$$ExternalSyntheticLambda0 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ CategoryFragment$$ExternalSyntheticLambda0(IpcDownloadablePreviewFragment ipcDownloadablePreviewFragment) {
        this.f$0 = ipcDownloadablePreviewFragment;
    }
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        switch (this.$r8$classId) {
            ...
            case 3:
                ...
                ((IpcDownloadablePreviewFragment) this.f$0).sendDownloadMessage(3);
                return;
            case 4:
            ...
            default:
                ...
                int i4 = StartRotationDialogFragment.$r8$clinit;
