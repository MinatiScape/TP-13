...
public class CategoryFragment extends AppbarFragment implements CategorySelectorFragment.CategorySelectorFragmentHost, WallpaperPickerRecyclerViewAccessibilityDelegate.BottomSheetHost, IndividualPickerFragment.IndividualPickerFragmentHost {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final View inflate = layoutInflater.inflate(R.layout.fragment_category_picker, viewGroup, false);
        ...
        this.mPreviewPager.mExternalPageListener = new ViewPager.OnPageChangeListener() { // from class: com.android.wallpaper.picker.CategoryFragment.1
            ...
            public void onPageScrolled(int i, float f, int i2) {
                ...
                if (wallpaperConnection != null && wallpaperConnection.mEngineReady && (categoryFragment.mHomePreviewWallpaperInfo instanceof LiveWallpaperInfo)) {
                    if (f == HingeAngleProviderKt.FULLY_CLOSED_DEGREES || f == 1.0f || i2 == 0) {
        ...
        if ((activity.getPackageManager().checkPermission("android.permission.READ_WALLPAPER_INTERNAL", activity.getPackageName()) == 0) || getFragmentHost().isReadExternalStoragePermissionGranted()) {
            ...
            ((Button) inflate.findViewById(R.id.permission_needed_allow_access_button)).setOnClickListener(new View.OnClickListener() { // from class: com.android.wallpaper.picker.CategoryFragment$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    final CategoryFragment categoryFragment = CategoryFragment.this;
                    final View view2 = inflate;
                    int i = CategoryFragment.$r8$clinit;
                    categoryFragment.getFragmentHost().requestExternalStoragePermission(new MyPhotosStarter.PermissionChangedListener() { // from class: com.android.wallpaper.picker.CategoryFragment.4
                        ...
                        public void onPermissionsGranted() {
                            ...
                            View view3 = view2;
                            int i2 = CategoryFragment.$r8$clinit;
                            categoryFragment2.showCurrentWallpaper(view3, true);
        ...
        viewGroup3.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.android.wallpaper.picker.CategoryFragment.3
            ...
            public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                ...
                cardView.setRadius(SizeCalculator.getPreviewCornerRadius(CategoryFragment.this.getActivity(), cardView.getMeasuredWidth()));
                CardView cardView3 = cardView2;
                if (cardView3 != null) {
                    cardView3.setRadius(SizeCalculator.getPreviewCornerRadius(CategoryFragment.this.getActivity(), viewGroup2.getMeasuredWidth()));
                }
            }
        });
        ...
        String collectionId = R$color.getCollectionId(intent);
                    ...
                    public void run() {
                        ...
                        if (CategoryFragment.this.getActivity() != null) {
                            ...
                            if (wallpaperInfo3 != null && imageView != null && (activity = categoryFragment.getActivity()) != null) {
                                ...
                                if (imageView2 != null) {
                                    wallpaperInfo3.getThumbAsset(activity.getApplicationContext()).loadPreviewImage(activity, imageView2, R$id.getColorAttr(categoryFragment.getActivity(), 16844080));
                                }
                                if (z) {
                                    if (categoryFragment.mWallpaperSurfaceCallback.mHomeImageWallpaper != null) {
                                        wallpaperInfo3.getThumbAsset(activity.getApplicationContext()).loadPreviewImage(activity, categoryFragment.mWallpaperSurfaceCallback.mHomeImageWallpaper, R$id.getColorAttr(categoryFragment.getActivity(), 16844080));
                                    }
