...
public class IndividualPickerFragment extends AppbarFragment implements RotationStarter, StartRotationErrorDialogFragment.Listener, CurrentWallpaperBottomSheetPresenter.RefreshListener, SetWallpaperErrorDialogFragment.Listener, SetWallpaperDialogFragment.Listener, StartRotationDialogFragment.Listener {
    ...
    public class IndividualAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        /* renamed from: com.android.wallpaper.picker.individual.IndividualPickerFragment$IndividualAdapter$1  reason: invalid class name */
        /* loaded from: classes.dex */
        public class AnonymousClass1 implements SetIndividualHolder.OnSetListener {
        ...
        public static void access$200(IndividualAdapter individualAdapter, int i) {
            ...
            if (individualAdapter.mPendingSelectedAdapterPosition != individualAdapter.mSelectedAdapterPosition) {
                ...
                if (currentWallpaperBottomSheetPresenter != null) {
                    ...
                    Runnable runnable2 = new Runnable() { // from class: com.android.wallpaper.picker.individual.IndividualPickerFragment.IndividualAdapter.2
                        @Override // java.lang.Runnable
                        public void run() {
                    ...
                    individualPickerFragment3.mCurrentWallpaperBottomSheetExpandedRunnable = runnable2;
                    individualPickerFragment3.mHandler.postDelayed(runnable2, 100L);
                }
                if (IndividualPickerFragment.this.getActivity() != null) {
                    int i3 = individualAdapter.mSelectedAdapterPosition;
                    boolean z = false;
                    if (i3 >= 0) {
                        RecyclerView.ViewHolder findViewHolderForAdapterPosition = IndividualPickerFragment.this.mImageGrid.findViewHolderForAdapterPosition(i3);
                    ...
                    if (i / ((GridLayoutManager) IndividualPickerFragment.this.mImageGrid.getLayoutManager()).mSpanCount == ((int) Math.ceil(individualAdapter.getItemCount() / i2)) - 1) {
                        z = true;
                    }
        ...
        */
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            if (i == 1) {
                ...
                return new SetIndividualHolder(IndividualPickerFragment.this.getActivity(), IndividualPickerFragment.this.mTileSizePx.y, inflate2, new EmptySelectionAnimator(individualPickerFragment2), new AnonymousClass1());
            } else if (i != 3) {
    ...
    public static void access$300(IndividualPickerFragment individualPickerFragment, DesktopRotationHolder desktopRotationHolder) {
        Asset thumbAsset = individualPickerFragment.mWallpapers.get(individualPickerFragment.mRandom.nextInt(individualPickerFragment.mWallpapers.size())).getThumbAsset(individualPickerFragment.getActivity());
        Asset.DrawableLoadedListener drawableLoadedListener = new Asset.DrawableLoadedListener() { // from class: com.android.wallpaper.picker.individual.IndividualPickerFragment.3
            @Override // com.android.wallpaper.asset.Asset.DrawableLoadedListener
            public void onDrawableLoaded() {
                if (IndividualPickerFragment.this.getActivity() != null) {
                    IndividualPickerFragment individualPickerFragment2 = IndividualPickerFragment.this;
                    individualPickerFragment2.mHandler.postDelayed(individualPickerFragment2.mUpdateDailyWallpaperThumbRunnable, 4000);
                }
            }
        };
        int colorAttr = R$id.getColorAttr(desktopRotationHolder.mActivity, 16844080);
        thumbAsset.loadDrawableWithTransition(desktopRotationHolder.mActivity, desktopRotationHolder.mThumbnailView, desktopRotationHolder.mThumbnailView.getDrawable() == null ? 300 : RecyclerView.MAX_SCROLL_DURATION, drawableLoadedListener, colorAttr);
    }
    ...
    public int getNumColumns() {
        ...
        if (isFewerColumnLayout()) {
            return SizeCalculator.getNumColumns(activity, SizeCalculator.getActivityWindowWidthPx(activity), 2, 2);
        }
        return SizeCalculator.getNumColumns(activity, SizeCalculator.getActivityWindowWidthPx(activity), 3, 4);
    }
    ...
    public void highlightAppliedWallpaper(int i) {
        ...
        if (this.mWallpapers != null) {
            ...
            this.mAppliedWallpaperInfo = this.mWallpapers.stream().filter(IndividualPickerFragment$$ExternalSyntheticLambda1.INSTANCE).filter(new GridFragment$$ExternalSyntheticLambda2(str)).findFirst().orElse(null);
        ...
        if (!(this.mImageGrid == null || this.mCategory == null || getContext() == null)) {
            ...
            if (this.mAdapter == null || z) {
                ...
                if (isFewerColumnLayout()) {
                    ...
                    point = SizeCalculator.getSquareTileSize(SizeCalculator.getNumColumns(activity, activityWindowWidthPx, 2, 2), activityWindowWidthPx, resources.getDimensionPixelSize(R.dimen.grid_item_featured_individual_padding_horizontal), resources.getDimensionPixelSize(R.dimen.featured_wallpaper_grid_edge_space));
                } else {
                    FragmentActivity activity2 = getActivity();
                    Resources resources2 = activity2.getResources();
                    int activityWindowWidthPx2 = SizeCalculator.getActivityWindowWidthPx(activity2);
                    point = SizeCalculator.getSquareTileSize(SizeCalculator.getNumColumns(activity2, activityWindowWidthPx2, 3, 4), activityWindowWidthPx2, resources2.getDimensionPixelSize(R.dimen.grid_item_individual_padding_horizontal), resources2.getDimensionPixelSize(R.dimen.wallpaper_grid_edge_space));
                }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!wallpaperChangedNotifier.mListeners.contains(listener)) {
            wallpaperChangedNotifier.mListeners.add(listener);
        }
        ...
        this.mImageGrid.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.android.wallpaper.picker.individual.IndividualPickerFragment.6
            ...
            public void onScrolled(RecyclerView recyclerView, int i, final int i2) {
                ...
                if (individualPickerFragment.mCurrentWallpaperBottomSheetPresenter != null) {
                    ...
                    IndividualPickerFragment individualPickerFragment2 = IndividualPickerFragment.this;
                    Runnable runnable2 = new Runnable() { // from class: com.android.wallpaper.picker.individual.IndividualPickerFragment.6.1
                        @Override // java.lang.Runnable
                        public void run() {
                            if (i2 > 0) {
                    ...
                    individualPickerFragment2.mCurrentWallpaperBottomSheetExpandedRunnable = runnable2;
                    individualPickerFragment2.mHandler.postDelayed(runnable2, 100L);
                }
            }
        });
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x004a, code lost:
        if ((r1 instanceof com.android.wallpaper.model.DesktopCustomCategory) != false) goto L19;
     */
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0018, code lost:
        if ((r1 instanceof com.android.wallpaper.model.DesktopCustomCategory) != false) goto L8;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
                ...
                if (IndividualPickerFragment.this.mWallpaperRotationInitializer.startRotation(applicationContext)) {
                    if (activity != null) {
                        ...
                        if (individualPickerFragment.mFormFactor == 1) {
                            ...
                            activity.finish();
                            R$style.launchHome(applicationContext);
                            return;
                        }
                    }
                    IndividualPickerFragment individualPickerFragment2 = IndividualPickerFragment.this;
