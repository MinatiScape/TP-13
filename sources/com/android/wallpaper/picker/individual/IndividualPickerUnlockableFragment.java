...
public class IndividualPickerUnlockableFragment extends IndividualPickerFragment {
    ...
    public boolean isFewerColumnLayout() {
        Context context;
        return (this.mWallpapers == null || (context = getContext()) == null || this.mWallpapers.stream().filter(new GridFragment$$ExternalSyntheticLambda2(context)).count() > 8) ? false : true;
    }
