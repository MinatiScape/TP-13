...
public class ViewOnlyPreviewActivity extends BasePreviewActivity implements AppbarFragment.AppbarFragmentHost {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (supportFragmentManager.findFragmentById(R.id.fragment_container) == null) {
            ...
            Fragment previewFragment = InjectorProvider.getInjector().getPreviewFragment(this, (WallpaperInfo) intent.getParcelableExtra("com.android.wallpaper.picker.wallpaper_info"), 0, booleanExtra2, false, booleanExtra);
