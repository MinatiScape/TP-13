...
public class CustomizationPickerActivity extends FragmentActivity implements AppbarFragment.AppbarFragmentHost, WallpapersUiContainer, CategoryFragment.CategoryFragmentHost, BottomActionBar.BottomActionBarHost, FragmentTransactionChecker, PermissionRequester, CategorySelectorFragment.CategorySelectorFragmentHost, IndividualPickerFragment.IndividualPickerFragmentHost, WallpaperPreviewNavigator {
    ...
    public void fetchCategories() {
        ...
        Objects.requireNonNull(wallpaperCategoryProvider);
        String obj = DownloadableLiveWallpaperInfo.getToBeInstalledComponent(this).toString();
        GoogleWallpaperPreferences googleWallpaperPreferences = (GoogleWallpaperPreferences) InjectorProvider.getInjector().getPreferences(this);
        boolean z2 = true;
    ...
    public void onCreate(Bundle bundle) {
        ...
        String collectionId = R$color.getCollectionId(intent2);
        ...
        }, ((DefaultCategoryProvider) wallpaperPickerDelegate.mCategoryProvider).resetIfNeeded());
    }
    ...
    public void onStart() {
        ...
        if (this.mNetworkStatusListener == null) {
            NetworkStatusNotifier.Listener customizationPickerActivity$$ExternalSyntheticLambda0 = new NetworkStatusNotifier.Listener() { // from class: com.android.wallpaper.picker.CustomizationPickerActivity$$ExternalSyntheticLambda0
