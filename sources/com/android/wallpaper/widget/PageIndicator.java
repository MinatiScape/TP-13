...
public class PageIndicator extends ViewGroup {
    ...
    public final AnonymousClass1 mAnimationCallback = new Animatable2.AnimationCallback() { // from class: com.android.wallpaper.widget.PageIndicator.1
    ...
    public static void forceAnimationOnUI(AnimatedVectorDrawable animatedVectorDrawable) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [com.android.wallpaper.widget.PageIndicator$1] */
    public PageIndicator(Context context, AttributeSet attributeSet) {
        ...
        this.mPageDotWidth = (int) (dimension * 0.4f);
    }
    ...
    public final void setIndex(int i) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            imageView.setTranslationX(HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
