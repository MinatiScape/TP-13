...
public class PreviewPager extends LinearLayout {
    ...
    public final void initIndicator() {
        ...
        this.mPageIndicator.setLocation(this.mViewPager.mCurItem);
    }
    ...
    public PreviewPager(Context context, AttributeSet attributeSet, int i) {
        ...
        findViewById.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.wallpaper.widget.PreviewPager$$ExternalSyntheticLambda0
        ...
        findViewById2.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.wallpaper.widget.PreviewPager$$ExternalSyntheticLambda0
            public final /* synthetic */ PreviewPager f$0;
        ...
        ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() { // from class: com.android.wallpaper.widget.PreviewPager.4
            @Override // androidx.viewpager.widget.ViewPager.OnPageChangeListener
            public void onPageScrollStateChanged(int i3) {
                ViewPager.OnPageChangeListener onPageChangeListener2 = PreviewPager.this.mExternalPageListener;
            ...
            public void onPageScrolled(int i3, float f, int i4) {
                PreviewPager.this.mPageIndicator.setLocation(Math.round((i3 + f) * 100.0f) / 100.0f);
                ViewPager.OnPageChangeListener onPageChangeListener2 = PreviewPager.this.mExternalPageListener;
                if (onPageChangeListener2 != null) {
                    onPageChangeListener2.onPageScrolled(i3, f, i4);
                }
            }
