...
public class CurrentWallpaperAssetVN extends StreamableAsset {
    ...
    public CurrentWallpaperAssetVN(Context context, int i) {
        ...
        WallpaperManagerCompatV16 wallpaperManagerCompatV16 = WallpaperManagerCompatV16.getInstance(context);
        this.mWallpaperManagerCompat = wallpaperManagerCompatV16;
        this.mWallpaperManagerFlag = i;
        this.mWallpaperId = wallpaperManagerCompatV16.getWallpaperId(i);
    }
