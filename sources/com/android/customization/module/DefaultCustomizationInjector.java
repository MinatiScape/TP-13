...
public class DefaultCustomizationInjector implements CustomizationInjector, Injector {
    ...
    public CornerTreatment mSystemFeatureChecker;
    ...
    public EdgeTreatment mWallpaperStatusChecker;
    ...
    @Override // com.android.wallpaper.module.Injector
    public synchronized zzam getRequester(Context context) {
        if (this.mRequester == null) {
            this.mRequester = new zzam(context.getApplicationContext());
        }
        return this.mRequester;
    }

    @Override // com.android.wallpaper.module.Injector
    public synchronized CornerTreatment getSystemFeatureChecker() {
        if (this.mSystemFeatureChecker == null) {
            this.mSystemFeatureChecker = new CornerTreatment(1);
        }
    ...
    @Override // com.android.wallpaper.module.Injector
    public EdgeTreatment getWallpaperStatusChecker() {
        if (this.mWallpaperStatusChecker == null) {
            this.mWallpaperStatusChecker = new EdgeTreatment(1);
        }
