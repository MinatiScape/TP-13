...
public class ThemedIconSectionController implements CustomizationSectionController<ThemedIconSectionView> {
    ...
    public ThemedIconSectionView createView(Context context) {
        ...
        themedIconSwitchProvider.mExecutorService.submit(new ImagePreviewFragment$4$$ExternalSyntheticLambda0(themedIconSwitchProvider, new ThemedIconSectionController$$ExternalSyntheticLambda0(this, 1)));
