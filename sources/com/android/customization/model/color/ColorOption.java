    ...
    public boolean isActive(CustomizationManager<ColorOption> customizationManager) {
        ...
        if (this.mIsDefault) {
            ...
            if (!TextUtils.isEmpty(storedOverlays) && !"{}".equals(storedOverlays)) {
                ...
                if (!colorCustomizationManager.mCurrentOverlays.isEmpty() && (storedOverlays.contains("android.theme.customization.system_palette") || storedOverlays.contains("android.theme.customization.accent_color"))) {
                    return false;
                }
            }
            return true;
