...
public final /* synthetic */ class RemoteTransitionCompat$1$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public final void run() {
        switch (this.$r8$classId) {
            case 0:
                RemoteTransitionCompat.AnonymousClass1.m15$r8$lambda$jwJx2V1LAnejviZsZXR1iMLhUc(this.f$0);
                return;
            default:
                RemoteTransitionCompat.AnonymousClass1.m14$r8$lambda$4bGfLVj4G1PZG6H5jtGCYBezCc(this.f$0);
                return;
        }
    }
}
