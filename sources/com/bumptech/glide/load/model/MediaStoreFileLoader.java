    ...
    public static class FilePathFetcher implements DataFetcher<File> {
        ...
        public void loadData(Priority priority, DataFetcher.DataCallback<? super File> callback) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                callback.onLoadFailed(new FileNotFoundException(Registry$NoModelLoaderAvailableException$$ExternalSyntheticOutline0.m(valueOf.length() + 30, "Failed to find file path for: ", valueOf)));
                return;
            }
            callback.onDataReady(new File(str));
        }
    }
