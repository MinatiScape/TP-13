    ...
    */
    public <X> com.bumptech.glide.load.Encoder<X> getSourceEncoder(X r5) throws com.bumptech.glide.Registry.NoSourceEncoderAvailableException {
        ...
        L11:
            ...
            com.bumptech.glide.provider.EncoderRegistry$Entry r2 = (com.bumptech.glide.provider.EncoderRegistry.Entry) r2     // Catch: java.lang.Throwable -> L38
            java.lang.Class<T> r3 = r2.dataClass     // Catch: java.lang.Throwable -> L38
            boolean r3 = r3.isAssignableFrom(r0)     // Catch: java.lang.Throwable -> L38
            if (r3 == 0) goto L11
            com.bumptech.glide.load.Encoder<T> r0 = r2.encoder     // Catch: java.lang.Throwable -> L38
            monitor-exit(r4)
            goto L2b
        L29:
            r0 = 0
