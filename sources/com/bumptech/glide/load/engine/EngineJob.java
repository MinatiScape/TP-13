...
public class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    public static class MainThreadCallback implements Handler.Callback {
        ...
        public boolean handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                throw new IllegalStateException(R$id$$ExternalSyntheticOutline0.m(33, "Unrecognized message: ", message.what));
            }
            return true;
        }
    }

    public EngineJob(GlideExecutor diskCacheExecutor, GlideExecutor sourceExecutor, GlideExecutor sourceUnlimitedExecutor, GlideExecutor animationExecutor, EngineJobListener listener, Pools$Pool<EngineJob<?>> pool, EngineResourceFactory engineResourceFactory) {
    ...
    public final void release(boolean isRemovedFromQueue) {
        boolean isComplete;
        Util.assertMainThread();
        this.cbs.clear();
        this.key = null;
        ...
        synchronized (releaseManager) {
            ...
            isComplete = releaseManager.isComplete(isRemovedFromQueue);
        }
        if (isComplete) {
    ...
    public void reschedule(DecodeJob<?> job) {
        ...
        glideExecutor.delegate.execute(job);
    }
}
