...
public class EngineKey implements Key {
    ...
    public EngineKey(Object model, Key signature, int width, int height, Map<Class<?>, Transformation<?>> transformations, Class<?> resourceClass, Class<?> transcodeClass, Options options) {
        Objects.requireNonNull(model, "Argument must not be null");
        this.model = model;
        Objects.requireNonNull(signature, "Signature must not be null");
        this.signature = signature;
        this.width = width;
        this.height = height;
        Objects.requireNonNull(transformations, "Argument must not be null");
        this.transformations = transformations;
        Objects.requireNonNull(resourceClass, "Resource class must not be null");
        this.resourceClass = resourceClass;
        Objects.requireNonNull(transcodeClass, "Transcode class must not be null");
