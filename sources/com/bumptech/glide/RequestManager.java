...
public class RequestManager implements LifecycleListener {
    ...
    public String toString() {
        ...
        return FragmentTabHost$SavedState$$ExternalSyntheticOutline0.m(R$attr$$ExternalSyntheticOutline0.m(valueOf2.length() + valueOf.length() + XMPPathFactory$$ExternalSyntheticOutline0.m(obj, 21), obj, "{tracker=", valueOf, ", treeNode="), valueOf2, "}");
    }
