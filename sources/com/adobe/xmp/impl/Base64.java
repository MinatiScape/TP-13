...
public class Base64 {
    ...
    public static final byte[] decode(byte[] src) throws IllegalArgumentException {
        ...
        while (i < i3 - 2) {
            int i5 = i4 + 1;
            bArr[i] = (byte) (((src[i4] << 2) & 255) | ((src[i5] >>> 4) & 3));
            int i6 = i4 + 2;
            bArr[i + 1] = (byte) (((src[i5] << 4) & 255) | ((src[i6] >>> 2) & 15));
            bArr[i + 2] = (byte) (((src[i6] << 6) & 255) | (src[i4 + 3] & 63));
            i4 += 4;
            i += 3;
        }
        if (i < i3) {
            bArr[i] = (byte) (((src[i4] << 2) & 255) | ((src[i4 + 1] >>> 4) & 3));
        }
        int i7 = i + 1;
        if (i7 < i3) {
