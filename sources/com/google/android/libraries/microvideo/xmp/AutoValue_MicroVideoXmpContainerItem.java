...
public final class AutoValue_MicroVideoXmpContainerItem extends MicroVideoXmpContainerItem {
    ...
    public String toString() {
        ...
        int i = this.length;
        int i2 = this.padding;
        StringBuilder m = R$attr$$ExternalSyntheticOutline0.m(XMPPathFactory$$ExternalSyntheticOutline0.m(str2, XMPPathFactory$$ExternalSyntheticOutline0.m(str, 85)), "MicroVideoXmpContainerItem{mime=", str, ", semantic=", str2);
        m.append(", length=");
        m.append(i);
        m.append(", padding=");
        m.append(i2);
