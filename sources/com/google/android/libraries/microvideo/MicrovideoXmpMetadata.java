...
public final class MicrovideoXmpMetadata {
    ...
    public static <T, E extends Throwable> T firstNonNull(ThrowableSupplier<T, E>... suppliers) throws Throwable {
        for (ThrowableSupplier<T, E> throwableSupplier : suppliers) {
    ...
    public static <T> T requiredValueMissing(String description) throws XMPException {
        throw new XMPException(description.length() != 0 ? "Property value missing for ".concat(description) : new String("Property value missing for "), 5);
    }
}
