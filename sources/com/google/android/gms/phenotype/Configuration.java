...
public class Configuration extends zzbkv implements Comparable<Configuration> {
    ...
    public final TreeMap flagMap = new TreeMap();
    public final int flagType;
    public final Flag[] flags;

    @Override // java.lang.Comparable
    public final int compareTo(Configuration configuration) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.flagType != configuration.flagType || !R$layout.zza(this.flagMap, configuration.flagMap) || !Arrays.equals(this.deleteFlags, configuration.deleteFlags)) {
            return false;
        }
        return true;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        R$id.zza(parcel, 4, this.deleteFlags);
        R$id.zzc(parcel, zzb);
    }
