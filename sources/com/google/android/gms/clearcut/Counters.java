...
public class Counters {
    ...
    public static final Comparator zzs = new zzp();
    ...
    public class BooleanHistogram extends AbstractCounter {
        public BooleanHistogram(Counters counters, BooleanHistogram booleanHistogram, boolean z, zzp zzpVar) {
    ...
    public class Counter extends AbstractCounter {
        public Counter(Counters counters, String str, zzp zzpVar) {
            super(str);
        }

        public Counter(Counters counters, Counter counter, boolean z, zzp zzpVar) {
    ...
    public class IntegerHistogram extends AbstractCounter {
        public IntegerHistogram(Counters counters, String str, zzp zzpVar) {
            super(str);
        }
        ...
        public IntegerHistogram(Counters counters, IntegerHistogram integerHistogram, boolean z, zzp zzpVar) {
    ...
    public class LongHistogram extends zza {
        public LongHistogram(Counters counters, LongHistogram longHistogram, boolean z, zzp zzpVar) {
    ...
    public class TimerHistogram extends zza {
        public TimerHistogram(Counters counters, TimerHistogram timerHistogram, boolean z, zzp zzpVar) {
    ...
    public class zza extends AbstractCounter {
        ...
        public zza(Counters counters, zza zzaVar, boolean z) {
    ...
    public void logAllAsync(LogEventModifier logEventModifier) {
        ...
        try {
            ...
            if (pendingResult == null) {
                ...
                R$string.zza(status, "Result must not be null");
