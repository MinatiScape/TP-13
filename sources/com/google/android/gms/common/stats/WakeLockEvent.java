...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        R$id.zzb(parcel, 8, 8);
        parcel.writeLong(j2);
        R$id.zza(parcel, 10, this.zze);
        int i4 = this.zzc;
        R$id.zzb(parcel, 11, 4);
        parcel.writeInt(i4);
        R$id.zza(parcel, 12, this.zzi);
        R$id.zza(parcel, 13, this.zzl);
        int i5 = this.zzk;
    ...
    public final String zzd() {
        ...
        StringBuilder sb = new StringBuilder(ParseRDF$$ExternalSyntheticOutline0.m(str3, ParseRDF$$ExternalSyntheticOutline0.m(str5, ParseRDF$$ExternalSyntheticOutline0.m(str4, ParseRDF$$ExternalSyntheticOutline0.m(str, ParseRDF$$ExternalSyntheticOutline0.m(str2, 45))))));
        sb.append("\t");
        sb.append(str2);
        sb.append("\t");
        sb.append(i);
