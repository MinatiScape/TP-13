...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public BaseGmsClient(Context context, Looper looper, GmsClientSupervisor gmsClientSupervisor, GoogleApiAvailabilityLight googleApiAvailabilityLight, int i, BaseConnectionCallbacks baseConnectionCallbacks, BaseOnConnectionFailedListener baseOnConnectionFailedListener, String str) {
        R$string.zza(context, "Context must not be null");
        this.zzi = context;
        R$string.zza(looper, "Looper must not be null");
        R$string.zza(gmsClientSupervisor, "Supervisor must not be null");
        this.zzk = gmsClientSupervisor;
        R$string.zza(googleApiAvailabilityLight, "API availability must not be null");
    ...
    public void connect(ConnectionProgressReportCallbacks connectionProgressReportCallbacks) {
        R$string.zza(connectionProgressReportCallbacks, "Connection progress callbacks cannot be null.");
    ...
    public void onUserSignOut(SignOutCallbacks signOutCallbacks) {
        zzbt zzbtVar = (zzbt) signOutCallbacks;
    ...
    public final T zzag() throws DeadObjectException {
        ...
        synchronized (this.zzm) {
            if (this.zzs == 5) {
                ...
                R$string.zza(this.zzp != null, "Client is connected but service is null");
                t = this.zzp;
            } else {
            ...
            if (i != 1) {
                if (i == 2 || i == 3) {
                    if (!(this.zzr == null || (zzuVar = this.zzh) == null)) {
                        ...
                        gmsClientSupervisor.unbindService(new GmsClientSupervisor.ConnectionStatusConfig(str2, "com.google.android.gms", 129), zzeVar, zzc2);
                        this.mDisconnectCount.incrementAndGet();
                    }
                    ...
                    if (!gmsClientSupervisor2.bindService(new GmsClientSupervisor.ConnectionStatusConfig(startServiceAction, "com.google.android.gms", 129), zzeVar2, zzc3)) {
                ...
                gmsClientSupervisor3.unbindService(new GmsClientSupervisor.ConnectionStatusConfig(startServiceAction2, "com.google.android.gms", 129), zzeVar3, zzc4);
                this.zzr = null;
            }
        }
    }
