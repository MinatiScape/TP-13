...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public static class zza<R extends Result> extends Handler {
        ...
        public final void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                Log.wtf("BasePendingResult", R$id$$ExternalSyntheticOutline0.m(45, "Don't know how to handle message: ", i), new Exception());
            } else {
    ...
    public final void zza(R r) {
        synchronized (this.zza) {
            ...
            zze();
            boolean z = true;
            R$string.zza(!zze(), "Results have already been set");
            if (this.zzk) {
                z = false;
            }
            R$string.zza(z, "Result has already been consumed");
            zzc(r);
        }
    }
    ...
    public final void zzc(R r) {
        ...
        if (this.zzl) {
            ...
            zzaVar.sendMessage(zzaVar.obtainMessage(1, new Pair(resultCallback, zza2)));
        ...
        int i = 0;
        while (i < size) {
            PendingResult.zza zzaVar2 = arrayList.get(i);
            i++;
            zzaVar2.zza(this.zzj);
        }
        this.zzf.clear();
    }
    ...
    public final R zza() {
        R r;
        synchronized (this.zza) {
            R$string.zza(!this.zzk, "Result has already been consumed.");
            R$string.zza(zze(), "Result is not ready.");
            r = this.zzi;
            this.zzi = null;
            this.zzg = null;
            this.zzk = true;
