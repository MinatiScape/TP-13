...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public static Dialog zza(Context context, int i, zzg zzgVar, DialogInterface.OnCancelListener onCancelListener) {
        String str;
        ...
        if (str != null) {
            builder.setPositiveButton(str, zzgVar);
        }
    ...
    public static void zza(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        if (activity instanceof FragmentActivity) {
            ...
            R$string.zza(dialog, "Cannot display null dialog");
