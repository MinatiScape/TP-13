...
public class BackdropWallpaperRotationInitializer implements WallpaperRotationInitializer {
        ...
        public void onSuccess(final ImaxWallpaperProto$Image imaxWallpaperProto$Image, final String str) {
            ...
            InjectorProvider.getInjector().getRequester(this.mAppContext).loadImageBitmap(createRotatingWallpaperUri, new SimpleTarget<Bitmap>() { // from class: com.google.android.apps.wallpaper.backdrop.BackdropWallpaperRotationInitializer.NextImageCallback.1
                ...
                public void onResourceReady(Object obj, Transition transition) {
                    ...
                    List<String> parseAttributions = R$style.parseAttributions(imaxWallpaperProto$Image.getAttributionList(), BackdropWallpaperRotationInitializer.this.mCollectionName);
                    int cropAndSetWallpaperBitmapInRotationStatic = ((DefaultWallpaperPersister) InjectorProvider.getInjector().getWallpaperPersister(NextImageCallback.this.mAppContext)).cropAndSetWallpaperBitmapInRotationStatic(bitmap, parseAttributions, imaxWallpaperProto$Image.getActionUrl(), BackdropWallpaperRotationInitializer.this.mCollectionId);
                    ...
                    BackdropWallpaperRotationInitializer.this.mStagedActionLabelRes = R$id.getActionLabelForType(imaxWallpaperProto$Image.getType().getNumber());
                    BackdropWallpaperRotationInitializer.this.mStagedActionIconRes = R$id.getActionIconForType(imaxWallpaperProto$Image.getType().getNumber());
                    ...
                    InjectorProvider.getInjector().getPreferences(NextImageCallback.this.mAppContext).updateDailyWallpaperSet(InjectorProvider.getInjector().getWallpaperStatusChecker().isLockWallpaperSet(NextImageCallback.this.mAppContext) ? 0 : 2, BackdropWallpaperRotationInitializer.this.mCollectionId, String.valueOf(imaxWallpaperProto$Image.getAssetId()));
                }
            });
        }
    }
    ...
    public boolean startRotation(Context context) {
        ...
        DefaultWallpaperPreferences$$ExternalSyntheticOutline0.m(backdropPreferences.mSharedPrefs, "collection_id", this.mCollectionId);
        DefaultWallpaperPreferences$$ExternalSyntheticOutline0.m(backdropPreferences.mSharedPrefs, "collection_name", this.mCollectionName);
