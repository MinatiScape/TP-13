...
public class BackdropFetcher implements ServerFetcher {
    ...
    public final zzam mRequester;

    public BackdropFetcher(zzam zzamVar, FilteringLabelProvider filteringLabelProvider) {
        this.mRequester = zzamVar;
    ...
    public final List<String> getFilteringLabelList(Context context) {
        ...
        try {
            ...
            collection = (Set) properties.getKeyset().stream().filter(new GridFragment$$ExternalSyntheticLambda2(properties)).collect(Collectors.toSet());
        } catch (Exception e) {
