        ...
        public void onSuccess(final ImaxWallpaperProto$Image imaxWallpaperProto$Image, final String str) {
            ...
            injector.getRequester(this.mAppContext).loadImageBitmap(createRotatingWallpaperUri, new SimpleTarget<Bitmap>() { // from class: com.google.android.apps.wallpaper.backdrop.BackdropWallpaperRotator.NextImageCallback.1
                ...
                public void onResourceReady(Object obj, Transition transition) {
                    ...
                    if (!((DefaultWallpaperPersister) injector.getWallpaperPersister(NextImageCallback.this.mAppContext)).setWallpaperInRotation(bitmap, R$style.parseAttributions(imaxWallpaperProto$Image.getAttributionList(), NextImageCallback.this.mCollectionName), R$id.getActionLabelForType(imaxWallpaperProto$Image.getType().getNumber()), R$id.getActionIconForType(imaxWallpaperProto$Image.getType().getNumber()), imaxWallpaperProto$Image.getActionUrl(), NextImageCallback.this.mCollectionId)) {
                    ...
                    boolean isLockWallpaperSet = InjectorProvider.getInjector().getWallpaperStatusChecker().isLockWallpaperSet(NextImageCallback.this.mAppContext);
