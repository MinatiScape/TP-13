    ...
    public final void run() {
        ...
        switch (this.$r8$classId) {
            ...
            case 1:
                ...
                clearcutUserEventLogger2.mCounters.getCounter("DailyWallpaper.RotationEnabled").incrementBase(0L, 1L);
            ...
            case 3:
                ...
                boolean isLockWallpaperSet = clearcutUserEventLogger4.mWallpaperStatusChecker.isLockWallpaperSet(clearcutUserEventLogger4.mContext);
