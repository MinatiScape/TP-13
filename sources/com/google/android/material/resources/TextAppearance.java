...
public class TextAppearance {
    ...
    public void getFontAsync(Context context, final zzgms zzgmsVar) {
        ...
        if (this.fontResolved) {
            zzgmsVar.onFontRetrieved(this.font, true);
            return;
        }
        try {
            ResourcesCompat.FontCallback fontCallback = new ResourcesCompat.FontCallback() { // from class: com.google.android.material.resources.TextAppearance.1
                ...
                public void onFontRetrievalFailed(int i2) {
                    ...
                    zzgmsVar.onFontRetrievalFailed(i2);
                }
                ...
                public void onFontRetrieved(Typeface typeface) {
                    ...
                    zzgmsVar.onFontRetrieved(textAppearance2.font, false);
                }
            };
            ...
            this.fontResolved = true;
            zzgmsVar.onFontRetrievalFailed(1);
        } catch (Exception e) {
            StringBuilder m = ExifInterface$ByteOrderedDataInputStream$$ExternalSyntheticOutline0.m("Error loading font ");
            m.append(this.fontFamily);
            Log.d("TextAppearance", m.toString(), e);
            this.fontResolved = true;
            zzgmsVar.onFontRetrievalFailed(-3);
        }
    }
    ...
    public void updateDrawState(Context context, TextPaint textPaint, zzgms zzgmsVar) {
        updateMeasureState(context, textPaint, zzgmsVar);
    ...
    public void updateMeasureState(Context context, final TextPaint textPaint, final zzgms zzgmsVar) {
        if (shouldLoadFontSynchronously(context)) {
        ...
        getFontAsync(context, new zzgms() { // from class: com.google.android.material.resources.TextAppearance.2
            ...
            public void onFontRetrievalFailed(int i) {
                zzgmsVar.onFontRetrievalFailed(i);
            }

            @Override // com.google.android.gms.internal.zzgms
            public void onFontRetrieved(Typeface typeface, boolean z) {
                TextAppearance.this.updateTextPaintMeasureState(textPaint, typeface);
                zzgmsVar.onFontRetrieved(typeface, z);
            }
        });
    }
    ...
    public void updateTextPaintMeasureState(TextPaint textPaint, Typeface typeface) {
        ...
        textPaint.setTextSkewX((i & 2) != 0 ? -0.25f : HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
