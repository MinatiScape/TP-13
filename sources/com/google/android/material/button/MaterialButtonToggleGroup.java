...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public static class CornerData {
        public static final CornerSize noCorner = new AbsoluteCornerSize(HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
        ...
        if (materialButton.isUsingOriginalBackground()) {
            ...
            if (materialShapeDrawable != null) {
                ...
                if (surfaceColorStrokeDrawable != null) {
                    surfaceColorStrokeDrawable.setStroke(materialButtonHelper.strokeWidth, materialButtonHelper.shouldDrawSurfaceColorStroke ? SizeCalculator.getColor(materialButtonHelper.materialButton, R.attr.colorSurface) : 0);
                }
            }
        }
        ...
        if (materialButton.isUsingOriginalBackground()) {
            ...
            ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.button.MaterialButtonToggleGroup.2
                ...
                public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(0, 1, i3, 1, false, ((MaterialButton) view2).isChecked()));
                }
            });
            return;
        }
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childButton.getVisibility() != 8) {
                if (childButton.isUsingOriginalBackground()) {
                    ...
                    if (cornerData2 == null) {
                        builder.setAllCornerSizes(HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
                    } else {
