...
public class CutoutDrawable extends MaterialShapeDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (callback instanceof View) {
            ...
            this.savedLayer = canvas.saveLayer(HingeAngleProviderKt.FULLY_CLOSED_DEGREES, HingeAngleProviderKt.FULLY_CLOSED_DEGREES, canvas.getWidth(), canvas.getHeight(), null);
        }
        super.draw(canvas);
