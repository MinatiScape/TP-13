...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    public final zzgms fontCallback;
    ...
    */
    public boolean dispatchHoverEvent(android.view.MotionEvent r11) {
        /*
            ...
            com.google.android.material.chip.Chip$ChipTouchHelper r8 = r10.touchHelper     // Catch: java.lang.NoSuchFieldException -> L47 java.lang.reflect.InvocationTargetException -> L4c java.lang.IllegalAccessException -> L51 java.lang.NoSuchMethodException -> L56
            ...
            com.google.android.material.chip.Chip$ChipTouchHelper r3 = r10.touchHelper     // Catch: java.lang.NoSuchFieldException -> L47 java.lang.reflect.InvocationTargetException -> L4c java.lang.IllegalAccessException -> L51 java.lang.NoSuchMethodException -> L56
    ...
    public boolean ensureAccessibleTouchTarget(int i) {
        ...
        if (max2 > 0 || max > 0) {
            ...
            this.insetBackgroundDrawable = new InsetDrawable((Drawable) this.chipDrawable, i3, i4, i3, i4);
            updateBackgroundDrawable();
            return true;
        }
        if (this.insetBackgroundDrawable != null) {
    ...
    public void onAttachedToWindow() {
        ...
        R$attr.setParentAbsoluteElevation(this, this.chipDrawable);
    }
    ...
    */
    ...
    public final void removeBackgroundInset() {
        if (this.insetBackgroundDrawable != null) {
            ...
            setMinWidth(0);
            ChipDrawable chipDrawable = this.chipDrawable;
            setMinHeight((int) (chipDrawable != null ? chipDrawable.chipMinHeight : HingeAngleProviderKt.FULLY_CLOSED_DEGREES));
            updateBackgroundDrawable();
        }
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        this.fontCallback = new zzgms() { // from class: com.google.android.material.chip.Chip.1
        ...
        ChipDrawable chipDrawable = new ChipDrawable(context2, attributeSet, i, R.style.Widget_MaterialComponents_Chip_Action);
        ...
        ThemeEnforcement.checkCompatibleTheme(context2, attributeSet, i, R.style.Widget_MaterialComponents_Chip_Action);
        ThemeEnforcement.checkTextAppearance(context2, attributeSet, iArr, i, R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        TypedArray obtainStyledAttributes2 = context2.obtainStyledAttributes(attributeSet, iArr, i, R.style.Widget_MaterialComponents_Chip_Action);
        ...
        ThemeEnforcement.checkCompatibleTheme(context2, attributeSet, i, R.style.Widget_MaterialComponents_Chip_Action);
        ThemeEnforcement.checkTextAppearance(context2, attributeSet, iArr, i, R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
        TypedArray obtainStyledAttributes3 = context2.obtainStyledAttributes(attributeSet, iArr, i, R.style.Widget_MaterialComponents_Chip_Action);
