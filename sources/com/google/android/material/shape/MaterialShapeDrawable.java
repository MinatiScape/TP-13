...
public class MaterialShapeDrawable extends Drawable implements Shapeable {
    ...
    public final PorterDuffColorFilter calculateTintFilter(ColorStateList colorStateList, PorterDuff.Mode mode, Paint paint, boolean z) {
        ...
        } else if (!z || (compositeElevationOverlayIfNeeded = compositeElevationOverlayIfNeeded((color = paint.getColor()))) == color) {
            return null;
        } else {
    ...
    */
    ...
    public final float getStrokeInsetLength() {
        return hasStroke() ? this.strokePaint.getStrokeWidth() / 2.0f : HingeAngleProviderKt.FULLY_CLOSED_DEGREES;
    }
    ...
    public final boolean hasStroke() {
        ...
        return (style == Paint.Style.FILL_AND_STROKE || style == Paint.Style.STROKE) && this.strokePaint.getStrokeWidth() > HingeAngleProviderKt.FULLY_CLOSED_DEGREES;
    }
