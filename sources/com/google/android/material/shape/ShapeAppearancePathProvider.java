...
public class ShapeAppearancePathProvider {
    ...
    public void calculatePath(ShapeAppearanceModel shapeAppearanceModel, float f, RectF rectF, PathListener pathListener, Path path) {
        ...
        while (i3 < 4) {
            ...
            float max = Math.max(((float) Math.hypot(f3 - fArr9[0], fArr[1] - fArr9[1])) - 0.001f, (float) HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
            ...
            this.shapePath.reset(HingeAngleProviderKt.FULLY_CLOSED_DEGREES, HingeAngleProviderKt.FULLY_CLOSED_DEGREES, 270.0f, HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
            if (i3 == 1) {
                c = 3;
