...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, View view, int i) {
            ...
            if (i4 >= 0 && (i3 & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    ...
                    i2 = Math.round(childAt.getHeight() * this.offsetToChildIndexOnLayoutPerc) + i5;
                }
                ...
                if ((i3 & 2) != 0) {
                    ...
                    if (z) {
                        animateOffsetTo(coordinatorLayout, appBarLayout, i6, HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
                    } else {
                        setHeaderTopBottomOffset(coordinatorLayout, appBarLayout, i6);
                    }
                } else if ((i3 & 1) != 0) {
                    if (z) {
                        animateOffsetTo(coordinatorLayout, appBarLayout, 0, HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
                    } else {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:15:0x0029, code lost:
            if (((r3.getTotalScrollRange() != 0) && r2.getHeight() - r4.getHeight() <= r3.getHeight()) != false) goto L17;
         */
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        /*
        ...
        public final void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (i >= 0) {
                ...
                if ((i3 & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, MathUtils.clamp(i4, -t.getTotalScrollRange(), 0), HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
                }
            }
        }
    ...
    public void onAttachedToWindow() {
        ...
        if (background instanceof MaterialShapeDrawable) {
            R$attr.setParentAbsoluteElevation(this, (MaterialShapeDrawable) background);
        }
    }
    ...
    public LinearLayout.LayoutParams mo19generateDefaultLayoutParams() {
        return new LayoutParams(-1, -2);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            if (obtainStyledAttributes2.hasValue(3)) {
                ...
                long j = integer;
                stateListAnimator.addState(new int[]{16842766, R.attr.state_liftable, -2130969410}, ObjectAnimator.ofFloat(this, "elevation", HingeAngleProviderKt.FULLY_CLOSED_DEGREES).setDuration(j));
                stateListAnimator.addState(new int[]{16842766}, ObjectAnimator.ofFloat(this, "elevation", obtainStyledAttributes2.getDimensionPixelSize(3, 0)).setDuration(j));
    ...
    public LinearLayout.LayoutParams mo20generateLayoutParams(AttributeSet attributeSet) {
        return new LayoutParams(getContext(), attributeSet);
    }
