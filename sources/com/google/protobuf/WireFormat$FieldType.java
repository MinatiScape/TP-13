...
public enum WireFormat$FieldType {
    ...
    STRING(WireFormat$JavaType.STRING, 2) { // from class: com.google.protobuf.WireFormat$FieldType.1
    },
    ...
    BYTES(WireFormat$JavaType.BYTE_STRING, 2) { // from class: com.google.protobuf.WireFormat$FieldType.4
    },
    UINT32(r11, 0),
