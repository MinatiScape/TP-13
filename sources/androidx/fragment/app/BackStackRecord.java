        ...
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder m = ExifInterface$ByteOrderedDataInputStream$$ExternalSyntheticOutline0.m("Bump nesting of ");
            ...
            for (int i = 0; i < size; i++) {
                ...
                switch (op.mCmd) {
                    ...
                    case 10:
                        ...
                        break;
                    default:
                        StringBuilder m = ExifInterface$ByteOrderedDataInputStream$$ExternalSyntheticOutline0.m("cmd=");
                        m.append(op.mCmd);
                        str2 = m.toString();
                        break;
                }
