        ...
        if (attributeValue != null) {
            ...
            if (z) {
                ...
                if (fragment == null) {
                    ...
                    fragment.onInflate(fragmentHostCallback.mContext, attributeSet, fragment.mSavedFragmentState);
                    ...
                    fragment.onInflate(fragmentHostCallback2.mContext, attributeSet, fragment.mSavedFragmentState);
