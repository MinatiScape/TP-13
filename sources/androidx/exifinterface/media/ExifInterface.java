...
public class ExifInterface {
            ...
            mediaMetadataRetriever.setDataSource(new MediaDataSource(this) { // from class: androidx.exifinterface.media.ExifInterface.1
                ...
                public int readAt(long j, byte[] bArr, int i, int i2) throws IOException {
                    ...
                    try {
                        ...
                        int read = byteOrderedDataInputStream2.mDataInputStream.read(bArr, i, i2);
                        byteOrderedDataInputStream2.mPosition += read;
                        if (read >= 0) {
                            this.mPosition += read;
                            return read;
                        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x0190, code lost:
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:33:0x00b3 A[FALL_THROUGH] */
    /*
    ...
    */
                ...
                if (byteOrderedDataInputStream.read(bArr2) == 4) {
                    ...
                    if (!Arrays.equals(bArr2, PNG_CHUNK_TYPE_IEND)) {
                        if (Arrays.equals(bArr2, PNG_CHUNK_TYPE_EXIF)) {
                            ...
                            throw new IOException("Failed to read given length for given PNG chunk type: " + R$layout.byteArrayToHexString(bArr2));
                        }
                        int i3 = readInt + 4;
            ...
            try {
                ...
                if (byteOrderedDataInputStream.read(bArr) == 4) {
                    ...
                    if (Arrays.equals(WEBP_CHUNK_TYPE_EXIF, bArr)) {
                        ...
                        throw new IOException("Failed to read given length for given PNG chunk type: " + R$layout.byteArrayToHexString(bArr));
                    }
                    if (readInt2 % 2 == 1) {
                        readInt2++;
                    }
    ...
    public final void handleThumbnailFromJfif(ByteOrderedDataInputStream byteOrderedDataInputStream, HashMap hashMap) throws IOException {
        ...
        if (exifAttribute != null && exifAttribute2 != null) {
            ...
            int min = Math.min(intValue2, byteOrderedDataInputStream.mLength - intValue);
            if (intValue > 0 && min > 0 && this.mAssetInputStream == null && this.mSeekableFileDescriptor == null) {
                byteOrderedDataInputStream.skip(intValue);
                byteOrderedDataInputStream.read(new byte[min]);
            }
            if (DEBUG) {
    ...
    public final void printAttributes() {
        for (int i = 0; i < this.mAttributes.length; i++) {
            ...
            for (Map.Entry<String, ExifAttribute> entry : this.mAttributes[i].entrySet()) {
                ...
                StringBuilder m = ExifInterface$ByteOrderedDataInputStream$$ExternalSyntheticOutline0.m("tagName: ");
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r26, int r27) throws java.io.IOException {
        /*
