...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild {
    ...
    */
    ...
    public final boolean onNestedFling(View view, float f, float f2, boolean z) {
        ...
        dispatchNestedFling(HingeAngleProviderKt.FULLY_CLOSED_DEGREES, f2, true);
        fling((int) f2);
        return true;
    }
    ...
    */
    ...
    public final boolean stopGlowAnimations(MotionEvent motionEvent) {
        ...
        if (EdgeEffectCompat$Api31Impl.getDistance(this.mEdgeGlowTop) != HingeAngleProviderKt.FULLY_CLOSED_DEGREES) {
            EdgeEffectCompat$Api31Impl.onPullDistance(this.mEdgeGlowTop, HingeAngleProviderKt.FULLY_CLOSED_DEGREES, motionEvent.getY() / getHeight());
            z = true;
        } else {
            z = false;
        }
        ...
        EdgeEffectCompat$Api31Impl.onPullDistance(this.mEdgeGlowBottom, HingeAngleProviderKt.FULLY_CLOSED_DEGREES, 1.0f - (motionEvent.getY() / getHeight()));
        return true;
    }
    ...
    */
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(ViewGroup.getChildMeasureSpec(i, getPaddingRight() + getPaddingLeft() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, IntMath.MAX_SIGNED_POWER_OF_TWO));
            }
        }
    }
    ...
    public final void onNestedScrollInternal(int i, int i2, int[] iArr) {
        ...
        this.mChildHelper.dispatchNestedScroll(scrollY2, i - scrollY2, i2, iArr);
    }
