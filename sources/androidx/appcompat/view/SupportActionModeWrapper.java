...
public final class SupportActionModeWrapper extends ActionMode {
    ...
    public static class CallbackWrapper implements ActionMode.Callback {
        ...
        public final boolean onCreateActionMode(ActionMode actionMode, MenuBuilder menuBuilder) {
            ...
            Menu orDefault = this.mMenus.getOrDefault(menuBuilder, null);
            if (orDefault == null) {
                orDefault = new MenuWrapperICS(this.mContext, menuBuilder);
                this.mMenus.put(menuBuilder, orDefault);
            }
            return callback.onCreateActionMode(actionModeWrapper, orDefault);
        }
        ...
        public final boolean onPrepareActionMode(ActionMode actionMode, MenuBuilder menuBuilder) {
            ...
            return callback.onPrepareActionMode(actionModeWrapper, orDefault);
        }
