...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public final void setHasEmbeddedTabs(boolean z) {
        ...
        if (!z) {
            ...
            ActionBarContainer actionBarContainer = this.mContainerView;
            View view = actionBarContainer.mTabContainer;
            if (view != null) {
            ...
            ActionBarContainer actionBarContainer2 = this.mContainerView;
            View view2 = actionBarContainer2.mTabContainer;
            if (view2 != null) {
                actionBarContainer2.removeView(view2);
            }
            actionBarContainer2.mTabContainer = null;
            this.mDecorToolbar.setEmbeddedTabView(null);
        }
        boolean z2 = true;
        ...
        actionBarOverlayLayout.mHasNonEmbeddedTabs = z2;
    }
