...
public final class AppCompatTextHelper {
    ...
    public final void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (tintTypedArray2.hasValue(0) && tintTypedArray2.getDimensionPixelSize(0, -1) == 0) {
            this.mView.setTextSize(0, HingeAngleProviderKt.FULLY_CLOSED_DEGREES);
        }
        ...
        if (appCompatTextViewAutoSizeHelper2.mAutoSizeTextType != 0) {
            int[] iArr4 = appCompatTextViewAutoSizeHelper2.mAutoSizeTextSizesInPx;
            if (iArr4.length > 0) {
        ...
        if (dimensionPixelSize2 != i2) {
            ...
            Paint.FontMetricsInt fontMetricsInt2 = textView9.getPaint().getFontMetricsInt();
            ...
            if (dimensionPixelSize2 > Math.abs(i4)) {
                textView9.setPadding(textView9.getPaddingLeft(), textView9.getPaddingTop(), textView9.getPaddingRight(), dimensionPixelSize2 - i4);
            }
            i3 = -1;
        } else {
            i3 = i2;
        ...
        if (dimensionPixelSize3 != i3) {
            ...
            if (dimensionPixelSize3 != textView10.getPaint().getFontMetricsInt(null)) {
                textView10.setLineSpacing(dimensionPixelSize3 - fontMetricsInt, 1.0f);
            }
        }
    }
