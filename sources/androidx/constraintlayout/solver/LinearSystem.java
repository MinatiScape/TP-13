    ...
    */
    ...
    public ArrayRow createRow() {
        ...
        if (arrayRow == null) {
            ...
            arrayRow.constantValue = HingeAngleProviderKt.FULLY_CLOSED_DEGREES;
    ...
    public void minimizeGoal(Row row) throws Exception {
        ...
        while (true) {
            ...
            ArrayRow[] arrayRowArr = this.mRows;
            if (arrayRowArr[i].variable.mType != 1 && arrayRowArr[i].constantValue < HingeAngleProviderKt.FULLY_CLOSED_DEGREES) {
                z = true;
                break;
            }
            i++;
        ...
        if (z) {
            ...
            while (!z2) {
                ...
                while (i6 < this.mNumRows) {
                    ...
                    if (arrayRow.variable.mType != 1 && !arrayRow.isSimpleDefinition && arrayRow.constantValue < f) {
                        ...
                        while (i8 < this.mNumColumns) {
                            SolverVariable solverVariable = ((SolverVariable[]) this.mCache.mIndexedVariables)[i8];
                ...
                if (i4 != -1) {
                    ...
                    arrayRow2.pivot(((SolverVariable[]) this.mCache.mIndexedVariables)[i5]);
