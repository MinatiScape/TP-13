...
public class VerticalWidgetRun extends WidgetRun {
        ...
        if (constraintAnchorArr2[2].mTarget != null && constraintAnchorArr2[3].mTarget != null) {
            ...
            if (target8 != null) {
                ...
                if (this.dimensionBehavior == 3) {
                    ...
                    if (constraintWidget15.mDimensionRatio > HingeAngleProviderKt.FULLY_CLOSED_DEGREES) {
            ...
            if (this.dimensionBehavior == 3) {
                ...
                if (constraintWidget16.mDimensionRatio > HingeAngleProviderKt.FULLY_CLOSED_DEGREES) {
    ...
    public void update(Dependency dependency) {
        ...
        float f2;
        float f3;
        if (SolverVariable$Type$r8$EnumUnboxingUtility.$enumboxing$ordinal(this.mRunType) != 3) {
