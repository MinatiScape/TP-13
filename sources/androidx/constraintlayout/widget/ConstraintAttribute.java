    ...
    public static void parse(Context context, XmlPullParser xmlPullParser, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (int i2 = 0; i2 < indexCount; i2++) {
            ...
            if (index == 0) {
                ...
                if (index == 7) {
                    obj = Float.valueOf(TypedValue.applyDimension(1, obtainStyledAttributes.getDimension(index, HingeAngleProviderKt.FULLY_CLOSED_DEGREES), context.getResources().getDisplayMetrics()));
                } else if (index == 4) {
                    obj = Float.valueOf(obtainStyledAttributes.getDimension(index, HingeAngleProviderKt.FULLY_CLOSED_DEGREES));
                } else if (index == 5) {
