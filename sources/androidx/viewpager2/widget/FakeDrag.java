...
public class FakeDrag {
    ...
    public boolean zzc(String str) {
        R$string.zza(str, "GcmTaskService must not be null.");
        List<ResolveInfo> zzd = zzd(str);
        if (zzd == null ? true : zzd.isEmpty()) {
        ...
        throw new IllegalArgumentException(FakeDrag$$ExternalSyntheticOutline0.m(str.length() + R.styleable.AppCompatTheme_windowActionBarOverlay, "The GcmTaskService class you provided ", str, " does not seem to support receiving com.google.android.gms.gcm.ACTION_TASK_READY"));
    }
