        ...
        if (z) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (!layoutParams.isDecor) {
                    layoutParams.widthFactor = HingeAngleProviderKt.FULLY_CLOSED_DEGREES;
                }
            }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i != -1) {
                ...
                int i2 = (f > HingeAngleProviderKt.FULLY_CLOSED_DEGREES ? 1 : (f == HingeAngleProviderKt.FULLY_CLOSED_DEGREES ? 0 : -1));
                if (i2 != 0) {
                    float f2 = this.mLastMotionX;
                    if (!(!this.mDragInGutterEnabled && ((f2 < ((float) this.mGutterSize) && i2 > 0) || (f2 > ((float) (getWidth() - this.mGutterSize)) && f < HingeAngleProviderKt.FULLY_CLOSED_DEGREES))) && canScroll(this, false, (int) f, (int) x2, (int) y2)) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i12 = 0; i12 < childCount2; i12++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), IntMath.MAX_SIGNED_POWER_OF_TWO), makeMeasureSpec);
            }
        }
    }
                ...
                if (!this.mIsBeingDragged) {
                    ...
                    if (findPointerIndex == -1) {
                        ...
                        if (abs > this.mTouchSlop && abs > abs2) {
                            ...
                            this.mLastMotionX = x2 - f > HingeAngleProviderKt.FULLY_CLOSED_DEGREES ? f + this.mTouchSlop : f - this.mTouchSlop;
                            this.mLastMotionY = y2;
                            setScrollState(1);
                            setScrollingCacheEnabled(true);
    ...
    */
    ...
    public final void recomputeScrollPosition(int i, int i2, int i3, int i4) {
        if (i2 <= 0 || this.mItems.isEmpty()) {
            ...
            int min = (int) ((infoForPosition != null ? Math.min(infoForPosition.offset, this.mLastOffset) : HingeAngleProviderKt.FULLY_CLOSED_DEGREES) * ((i - getPaddingLeft()) - getPaddingRight()));
            if (min != getScrollX()) {
                completeScroll(false);
            ...
            if (getChildCount() == 0) {
                ...
                if (i6 == 0 && i7 == 0) {
                    ...
                    if (abs > 0) {
                        ...
                        Objects.requireNonNull(this.mAdapter);
                        i4 = (int) (((Math.abs(i6) / ((f * 1.0f) + this.mPageMargin)) + 1.0f) * 100.0f);
                    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public int position;
        public float widthFactor = HingeAngleProviderKt.FULLY_CLOSED_DEGREES;
