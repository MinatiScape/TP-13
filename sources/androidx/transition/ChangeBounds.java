...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (i14 != 2) {
            changeBounds = this;
            if (i2 == i3 && i4 == i5) {
                objectAnimator = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, changeBounds.mPathMotion.getPath(i6, i8, i7, i9));
            } else {
                objectAnimator = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, changeBounds.mPathMotion.getPath(i2, i4, i3, i5));
            }
        } else if (i10 == i12 && i11 == i13) {
            changeBounds = this;
            objectAnimator = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, changeBounds.mPathMotion.getPath(i2, i4, i3, i5));
        } else {
            changeBounds = this;
            ViewBounds viewBounds = new ViewBounds(view);
            ObjectAnimator ofPointF = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, changeBounds.mPathMotion.getPath(i2, i4, i3, i5));
            ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, changeBounds.mPathMotion.getPath(i6, i8, i7, i9));
