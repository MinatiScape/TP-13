...
public class PagerSnapHelper extends SnapHelper {
    ...
    public final int distanceToCenter(View targetView, OrientationHelper helper) {
        return ((helper.getDecoratedMeasurement(targetView) / 2) + helper.getDecoratedStart(targetView)) - ((helper.getTotalSpace() / 2) + helper.getStartAfterPadding());
    }
    ...
    public final View findCenterView(RecyclerView.LayoutManager layoutManager, OrientationHelper helper) {
        ...
        int totalSpace = (helper.getTotalSpace() / 2) + helper.getStartAfterPadding();
