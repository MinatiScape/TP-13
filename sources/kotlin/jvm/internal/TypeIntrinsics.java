...
public class TypeIntrinsics {
    public static Object beforeCheckcastToFunctionOfArity(Object obj, int i) {
        ...
        ClassCastException classCastException = new ClassCastException(AbstractResolvableFuture$$ExternalSyntheticOutline0.m(obj.getClass().getName(), " cannot be cast to ", ExifInterface$$ExternalSyntheticOutline0.m("kotlin.jvm.functions.Function", i)));
