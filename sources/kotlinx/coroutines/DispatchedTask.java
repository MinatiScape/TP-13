...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void handleFatalException$kotlinx_coroutines_core(@Nullable Throwable th, @Nullable Throwable th2) {
        if (th != null || th2 != null) {
            ...
            if (th != null) {
                JobKt.handleCoroutineException(getDelegate$kotlinx_coroutines_core().getContext(), new CoroutinesInternalError(str, th));
                return;
            }
            Intrinsics.throwNpe();
            throw null;
        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                if (th == null && job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(cause, continuation)));
                } else if (th != null) {
                ...
                handleFatalException$kotlinx_coroutines_core(null, Result.m32exceptionOrNullimpl(obj2));
                return;
            }
            ...
            handleFatalException$kotlinx_coroutines_core(th3, Result.m32exceptionOrNullimpl(obj));
        }
    }
